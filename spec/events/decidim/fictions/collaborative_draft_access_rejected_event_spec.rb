...
describe Decidim::Fictions::CollaborativeDraftAccessRejectedEvent do
  include_context "when a simple event"

  let(:event_name) { "decidim.events.fictions.collaborative_draft_access_rejected" }
  ...
  context "when the notification is for the requester" do
    let(:event_name) { "decidim.events.fictions.collaborative_draft_access_requester_rejected" }
