...
describe Decidim::Fictions::Log::ResourcePresenter, type: :helper do
  let(:presenter) { described_class.new(resource, helper, extra) }
  let(:resource) { create(:fiction, title: Faker::Book.unique.title) }
  let(:extra) do
    {
  ...
  context "when the resource exists" do
    it "links to its public page with the name of the fiction" do
