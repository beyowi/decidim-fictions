...
describe "Amendment Wizard", type: :system do
  ...
  let!(:fiction) { create(:fiction, title: "More roads and less sidewalks", component: component) }
  ...
  context "when amending a fiction" do
    before do
    ...
    context "and in step_1: Create your amendment" do
      ...
      context "when the back button is clicked" do
        ...
        it "redirects to the fiction page" do
          expect(page).to have_content(fiction.title)
          expect(page).to have_content("AMEND FICTION")
        end
      end
    end
    ...
    context "and in step_2: Compare your amendment" do
      context "with similar results" do
        let!(:emendation) { create(:fiction, title: title, body: body, component: component) }
    ...
    context "and in step_4: Publish your amendment" do
      ...
      context "when the Publish button is clicked", versioning: true do
        ...
        it "publishes the amendment" do
          expect(page).to have_css(".callout.warning", text: "This amendment for the fiction #{fiction.title} is being evaluated.")
  ...
  context "with existing amendment drafts" do
    ...
    let!(:amendment) { create :amendment, amendable: fiction, emendation: emendation }
    let!(:emendation_draft) { create(:fiction, :unpublished, component: component) }
    let!(:amendment_draft) { create :amendment, :draft, amendable: fiction, emendation: emendation_draft }

    context "and visiting an amended fiction" do
      before do
        visit fiction_path
      end
