...
describe "Edit collaborative_drafts", type: :system do
  ...
  let!(:component) { create(:fiction_component, :with_collaborative_drafts_enabled, organization: organization) }
  ...
  describe "editing my own collaborative draft" do
    ...
    context "when updating with wrong data" do
      it "returns an error message" do
        ...
        within "form.edit_collaborative_draft" do
          fill_in :collaborative_draft_body, with: "WE DO NOT WANT TO SHOUT IN THE FICTION BODY TEXT!"
          click_button "Send"
        end
