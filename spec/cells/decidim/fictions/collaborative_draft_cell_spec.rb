...
describe Decidim::Fictions::CollaborativeDraftCell, type: :cell do
  controller Decidim::Fictions::CollaborativeDraftsController

  subject { my_cell.call(:show) }

  let(:my_cell) { cell("decidim/fictions/collaborative_draft", collaborative_draft, context: context) }
