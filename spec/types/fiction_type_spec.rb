...
module Decidim
  module Fictions
    describe FictionType, type: :graphql do
      include_context "with a graphql type"
      let(:component) { create(:fiction_component) }
      let(:model) { create(:fiction, :with_votes, :with_endorsements, :with_amendments, component: component) }
      ...
      describe "id" do
        ...
        it "returns the fiction's id" do
      ...
      describe "voteCount" do
        ...
        context "when votes are not hidden" do
          it "returns the amount of votes for this fiction" do
            expect(response["voteCount"]).to eq(model.votes.count)
          end
        end

        context "when votes are hidden" do
          let(:component) { create(:fiction_component, :with_votes_hidden) }
      ...
      describe "body" do
        ...
        it "returns the fiction's body" do
      ...
      describe "state" do
        ...
        it "returns the fiction's state" do
      ...
      context "when is answered" do
        ...
        describe "answer" do
          ...
          it "returns the fiction's answer" do
      ...
      describe "address" do
        ...
        it "returns the address of this fiction" do
      ...
      describe "participatory_text_level" do
        ...
        it "returns the participatory_text_level of this fiction" do
      ...
      describe "position" do
        ...
        it "returns the position of this fiction" do
      ...
      describe "created_in_meeting" do
        ...
        it "returns the created_in_meeting of this fiction" do
      ...
      describe "meeting" do
        ...
        let(:model) { create(:fiction, :official_meeting, component: component) }

        it "returns the meeting of this fiction" do
