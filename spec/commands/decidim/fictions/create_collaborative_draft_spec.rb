...
module Decidim
  module Fictions
    describe CreateCollaborativeDraft do
      ...
      let(:component) { create(:fiction_component, :with_collaborative_drafts_enabled, :with_extra_hashtags, suggested_hashtags: suggested_hashtags.join(" ")) }
      ...
      describe "call" do
        ...
        describe "when the form is not valid" do
          ...
          it "doesn't create a collaborative draft" do
            expect do
              command.call
            end.not_to change(Decidim::Fictions::CollaborativeDraft, :count)
          end
        end
        ...
        describe "when the form is valid" do
          ...
          it "creates a new collaborative draft" do
            expect do
              command.call
            end.to change(Decidim::Fictions::CollaborativeDraft, :count).by(1)
          end
          ...
          context "with an author" do
            ...
            it "sets the author" do
              command.call
              collaborative_draft = Decidim::Fictions::CollaborativeDraft.last
          ...
          context "when attachments are allowed", processing_uploads_for: Decidim::AttachmentUploader do
            ...
            it "creates an atachment for the fiction" do
              ...
              last_collaborative_draft = Decidim::Fictions::CollaborativeDraft.last
