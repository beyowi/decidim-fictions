...
module Decidim
  module Fictions
    describe CollaborativeDraftsController, type: :controller do
      ...
      let(:component) { create(:fiction_component, :with_creation_enabled, :with_collaborative_drafts_enabled) }
      ...
      describe "GET index" do
        context "when invoked without paramters" do
          it "returns a list of open collaborative drafts by updated_at" do
            ...
            expect(subject).to render_template("decidim/fictions/collaborative_drafts/index")
          end
        end
      end
      ...
      describe "GET show" do
        it "returns details of a collaborative_draft" do
          ...
          expect(response).to have_http_status(:ok)
          expect(assigns(:collaborative_draft)).to be_kind_of(Decidim::Fictions::CollaborativeDraft)
          expect(subject).to render_template("decidim/fictions/collaborative_drafts/show")
        end
      end
      ...
      describe "POST create" do
        ...
        context "when creation is not enabled" do
          let(:component) { create(:fiction_component, :with_collaborative_drafts_enabled) }
