  ...
  module Fictions
    ...
    module CollaborativeDraftHelper
      def filter_collaborative_drafts_state_values
        scope = "decidim.fictions.collaborative_drafts.filters"
      ...
      def accept_request_button_label
        t("accept_request", scope: "decidim.fictions.collaborative_drafts.requests.collaboration_requests")
      end

      def reject_request_button_label
        t("reject_request", scope: "decidim.fictions.collaborative_drafts.requests.collaboration_requests")
      end
    end
  end
end
