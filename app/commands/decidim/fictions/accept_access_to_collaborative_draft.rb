    ...
    class AcceptAccessToCollaborativeDraft < Rectify::Command
      ...
      def notify_collaborative_draft_authors
        ...
        Decidim::EventsManager.publish(
          event: "decidim.events.fictions.collaborative_draft_access_accepted",
          event_class: Decidim::Fictions::CollaborativeDraftAccessAcceptedEvent,
      ...
      def notify_collaborative_draft_requester
        Decidim::EventsManager.publish(
          event: "decidim.events.fictions.collaborative_draft_access_requester_accepted",
          event_class: Decidim::Fictions::CollaborativeDraftAccessRequesterAcceptedEvent,
          resource: @collaborative_draft,
