...
describe "Amend Fiction", versioning: true, type: :system do
  ...
  let!(:fiction) { create(:fiction, title: "Long enough title", component: component) }
  let!(:emendation) { create(:fiction, title: "Amended Long enough title", component: component) }
  ...
  context "when visiting an amended fiction" do
    before do
      visit fiction_path
    end
  ...
  context "with amendments NOT enabled" do
    ...
    context "when amendment CREATION is enabled" do
      ...
      context "and visits an amendable fiction" do
        before do
          visit fiction_path
        end

        it "is NOT shown a link to Amend it" do
          expect(page).not_to have_link("Amend Fiction")
        end
      end
    end
    ...
    context "when amendment REACTION is enabled" do
      ...
      context "and the fiction author visits an emendation to their fiction" do
    ...
    context "when amendment PROMOTION is enabled" do
      ...
      context "and the author of a rejected emendation visits their emendation" do
        ...
        it "is NOT shown the promote button" do
          expect(page).not_to have_content("PROMOTE TO FICTION")
          expect(page).not_to have_content("You can promote this emendation and publish it as an independent fiction")
        end
      end
    end
    ...
    context "when amendments VISIBILITY is set to 'participants'" do
      ...
      context "when the user is logged in" do
        ...
        context "and visit an amendable fiction that they have amended" do
          let(:user) { emendation.creator_author }
        ...
        context "and visit an amendable fiction that they have NOT amended" do
      ...
      context "when the user is NOT logged in" do
        ...
        context "and visit an amendable fiction" do
          it "is shown the emendation from other users in the amendments list" do
            within ".amendment-list" do
              expect(page).to have_content(emendation.title)
            end
  ...
  context "with amendments enabled" do
    ...
    context "when amendment CREATION is enabled" do
      ...
      context "and visits an amendable fiction from a private yet transparent space" do
        ...
        context "when a private user is logged in" do
          ...
          it "is shown a link to Amend it" do
            expect(page).to have_link("Amend Fiction")
          end
        end
      end
    ...
    context "when amendment REACTION is enabled" do
      ...
      context "and the fiction author visits an emendation to their fiction" do
        ...
        context "when the user clicks on the accept button" do
          ...
          context "and the emendation is accepted" do
            ...
            it "is changed the state of the emendation" do
              expect(page).to have_css(".success", text: "This amendment for the fiction #{emendation.title} has been accepted")
            end
          end
        end
        ...
        context "when the user clicks on the reject button" do
          ...
          it "is changed the state of the emendation" do
            expect(page).to have_css(".callout.alert", text: "This amendment for the fiction #{fiction.title} was rejected")
          end
        end
      end
    end
    ...
    context "when amendment PROMOTION is enabled" do
      ...
      context "and the author of a rejected emendation visits their emendation" do
        ...
        it "is shown the promote button" do
          expect(page).to have_content("PROMOTE TO FICTION")
          expect(page).to have_content("You can promote this emendation and publish it as an independent fiction")
        end
        ...
        context "when the user clicks on the promote button" do
          ...
          it "is shown the Success Callout when the alert text is accepted" do
            accept_confirm
            expect(page).to have_content("The amendment has been successfully published as a new fiction")
          end
