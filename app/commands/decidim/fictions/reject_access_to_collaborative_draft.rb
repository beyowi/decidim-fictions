...
module Decidim
  module Fictions
    ...
    class RejectAccessToCollaborativeDraft < Rectify::Command
      ...
      # collaborative_draft     - A Decidim::Fictions::CollaborativeDraft object.
      ...
      def notify_collaborative_draft_authors
        Decidim::EventsManager.publish(
          event: "decidim.events.fictions.collaborative_draft_access_rejected",
          event_class: Decidim::Fictions::CollaborativeDraftAccessRejectedEvent,
      ...
      def notify_collaborative_draft_requester
        Decidim::EventsManager.publish(
          event: "decidim.events.fictions.collaborative_draft_access_requester_rejected",
          event_class: Decidim::Fictions::CollaborativeDraftAccessRequesterRejectedEvent,
          resource: @collaborative_draft,
