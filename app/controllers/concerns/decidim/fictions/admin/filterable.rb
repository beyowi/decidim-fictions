    ...
    module Admin
      module Filterable
        ...
        included do
          ...
          helper Decidim::Fictions::Admin::FilterableHelper
          ...
          def base_query
            ...
            accessible_fictions_collection
          end

          def accessible_fictions_collection
          ...
          # Decidim::Fictions::Admin::FilterableHelper#extra_dropdown_submenu_options_items
          def fiction_states
            Fiction::POSSIBLE_STATES.without("not_answered")
          end
        end
      end
    end
