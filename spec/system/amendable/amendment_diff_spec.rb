...
describe "Amendment Diff", versioning: true, type: :system do
  ...
  let!(:fiction) { create(:fiction, title: "Original long enough title", body: "Original one liner body", component: component) }
  # The first version of the emendation should hold the original fiction attribute values being amended.
  let!(:emendation) { create(:fiction, title: fiction.title, body: fiction.body, component: component) }
  ...
  context "when visiting an amendment to a fiction" do
    context "and the amendment is being evaluated" do
      before do
        fiction.update(title: "Updated long enough title", body: "Updated one liner body")
      ...
      it "shows the changed attributes compared to the last version of the amended fiction" do
    ...
    context "and the amendment is NOT being evaluated" do
      ...
      it "shows the changed attributes compared to the version of the amended fiction at the moment of making the amendment" do
        expect(page).to have_content('Amendment to "Updated long enough title"')
    ...
    context "and the emendation and the amendable have seemingly the same body but different newline escape sequences" do
      before do
        fiction.update(body: "One liner body\nAmended")
        # The last version of the emendation should hold the amending attribute values.
  ...
  context "when amendment REACTION is enabled" do
    ...
    context "and the fiction author is reviewing an emendation to their fiction before accepting it" do
