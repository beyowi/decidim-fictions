...
describe Decidim::Fictions::Metrics::FictionFollowersMetricMeasure do
  ...
  let(:draft) { create(:collaborative_draft, published_at: day, component: fictions_component) }
  let!(:follows) do
    create_list(:follow, 10, followable: fiction, created_at: day)
    create_list(:follow, 10, followable: draft, created_at: day)
    create_list(:follow, 10, followable: fiction, created_at: day - 1.week)
  end
